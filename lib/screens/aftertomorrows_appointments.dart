...
class AfterTomorrowAppointments extends StatefulWidget {
  @override
  _AfterTomorrowAppointmentsState createState() =>
      _AfterTomorrowAppointmentsState();
}

class _AfterTomorrowAppointmentsState extends State<AfterTomorrowAppointments> {
  @override
  ...
  Future fetchAppointmentsList() async {
    ...
    String formattedDate =
        outputFormat.format(DateTime(now.year, now.month, now.day + 2));
